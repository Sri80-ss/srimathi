...
function showModal(dateText) {
    ...
    if (eventOfTheDay) {
        ...
        // Check if the clicked date is today or a future date in the same month
        const clickedDate = new Date(dateText.split("-").reverse().join("-"));
        const currentDate = new Date(dt.getFullYear(), dt.getMonth(), dt.getDate());

        if (clickedDate >= currentDate) {
            // Add new event form only for today or future dates in the current month
